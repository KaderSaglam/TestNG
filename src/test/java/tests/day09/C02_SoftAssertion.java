...
public class C02_SoftAssertion {
    ...
    public void test01(){
        ...
        driver.findElement(By.xpath("//strong[text( )='Online Banking']")).click();//online backing incelendi
        driver.findElement(By.xpath("//span[@id='pay_bills_link']")).click();//pay bills tiklandi
        // 7. “Purchase Foreign Currency” tusuna basin
        ...
        String expectedListeStringOlarak="\"Select One\", \"Australia (dollar)\", " +
